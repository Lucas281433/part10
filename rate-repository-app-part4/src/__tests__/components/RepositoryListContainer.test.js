...
describe("RepositoryList", () => {
  describe("RepositoryListContainer", () => {
    it("renders repository information correctly", () => {
      ...
      expect(repositoryItems[0]).toHaveTextContent("2.8k");
      expect(repositoryItems[0]).toHaveTextContent("33.4k");
      ...
      expect(repositoryItems[1]).toHaveTextContent("1.7k");
